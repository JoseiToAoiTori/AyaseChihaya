...
yuuko.on('messageCreate', message => {
	if ((message.content.toLowerCase().includes('top 10 reasons') || message.content.toLowerCase().includes('top ten reasons')) && (message.guildID === '514203145333899276' || message.guildID === '386933744025468939') && !message.author.bot) {
